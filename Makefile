...
CPP_FILES             := internal_anim.cpp firm_update.cpp main.cpp network.cpp window.cpp stm32_flash.cpp status.cpp clock_and_systick.cpp error_handler.cpp hal_i2c.cpp hal_timer.cpp uart_and_dma.cpp
